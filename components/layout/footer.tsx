...
export const Footer: FC = () => {
  return (
    <div className="animate__animated animate__fadeInLeft animate__delay-1s pb-6 gap-10 pt-6 bg-color-white dark:bg-color-hitam shadow-lg shadow-color-hitam dark:shadow-color-dark">
      ...
      <div className="lg:w-full lg:flex flex-cols-1">
        <div className="justify-items-start mt-1 lg:w-full lg:flex lg:mt-10 lg:justify-between">
          <h1 className="mx-10 mt-2 font-semibold text-color-hitam dark:text-color-primary text-sm pb-3 border-t-color-accent">
            Copyright © 2024 by <a href="/"><span className="underline text-color-hitam dark:text-color-primary hover:text-color-accent">ZNUANIME</span></a>. All Rights Reserved.
          </h1>
