  ...
  return (
    <header className="bg-color-primary px-3 py-3 sm:px-10 dark:bg-color-hitam dark:text-color-primary overflow-hidden ">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center">
        ...
        <nav
          className="absolute z-50 left-0 w-full pb-5 px-11 font-semibold bg-color-primary dark:bg-color-hitam
            ...
            <li>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 ">
                  <Link href="/anime/top">
                    <DropdownMenuItem className=" hover:text-color-accent hover:underline transition-all duration-500 animate__animated animate__fadeInRight animate__delay-0.3s">Anime Terpopuler</DropdownMenuItem>
                  </Link>
                  <Link href="/manga/top">
                    <DropdownMenuItem className="hover:text-color-accent hover:underline transition-all duration-500 animate__animated animate__fadeInLeft animate__delay-0.3s">Manga Terpopuler</DropdownMenuItem>
                  </Link>
                  <Link href="/anime/recommendations">
                    <DropdownMenuItem className="hover:text-color-accent hover:underline transition-all duration-500 animate__animated animate__fadeInRight animate__delay-0.3s">Rekomendasi Anime</DropdownMenuItem>
                  </Link>
                </DropdownMenuContent>
              </DropdownMenu>
            </li>
