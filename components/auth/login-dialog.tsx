  ...
  if (isDesktop) {
    return (
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger
          className={cn(
            "w-full relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:text-color-accent hover:bg-color-dark dark:hover:bg-color-primary",
            classNames
          )}
        >
          Masuk
